...
import { MARKET_CATEGORIES } from '@/lib/communities';
...
export const MarketShowcase: React.FC<MarketShowcaseProps> = ({ onSelectCategory, selectedCategory }) => {
  ...
  return (
    <div className="mb-6">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h2 className="text-xl font-bold text-gray-900">Community Market</h2>
          <p className="text-sm text-gray-500">Handmade goods — same-day delivery by our drivers</p>
        </div>
